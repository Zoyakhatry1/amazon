...
function CheckoutItem({id,title,price,rating,description,category,image,hasPrime}) {
   ...
   const removeItemFromBasket=()=>{
    ...
    <div className='grid grid-cols-5'>
      ...
      <div className='col-span-3 mx-5'>
        ...
        <Currency quantity={price*20} currency="INR"/>
      ...
      <div className='flex flex-col space-y-2 mt-2 justify-self-end'>
